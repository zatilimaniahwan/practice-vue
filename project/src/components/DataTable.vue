          ...
          <template slot-scope="props">
            ...
            <b-table-column field="symbol" label="Sell Rate">{{ props.row.sellRate }}</b-table-column>
             <b-table-column field="removed" label=""  centered>
              <b-field grouped>
            <b-button size="is-medium" type="is-danger"  icon-left="minus-circle-outline" @click="unfavoriteCurrency(props.row.name)"></b-button>
              </b-field>
          </b-table-column>
          </template>
      </b-table>
      ...
      >
        <template slot-scope="props">
          ...
          <b-table-column field="bookmark" label=""  centered>
              <b-field grouped>
            <b-button size="is-medium" type="is-warning"  icon-left="star" @click="favoriteCurrency(props.row.name,props.row.symbol,props.row.rate,props.row.sellRate)"></b-button>
              </b-field>
          </b-table-column>
        </template>
      </b-table>
